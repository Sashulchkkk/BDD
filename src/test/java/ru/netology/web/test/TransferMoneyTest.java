...
public class TransferMoneyTest {
    ...
    @Order(1)
    @Test()
    @DisplayName("shouldTransferMoneyFromFirstToSecond")
    ...
    @DisplayName("shouldTransferMoneyFromSecondToFirst")
    @Order(2)
    @Test
    ...
    @DisplayName("shouldTransferMoneyFromSecondToSecond")
    @Order(3)
    @Test
    ...
    @DisplayName("shouldTransferMoneyFromFirstToFirst")
    @Order(4)
    @Test
    ...
    @DisplayName("shouldTransferMoneyFromFirstToSecondNegative")
    @Order(5)
    @Test
    ...
    @DisplayName("shouldTransferMoneyFromSecondToFirstNegative")
    @Order(6)
    @Test
